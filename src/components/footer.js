    ...
    <footer className="mt-100 bg-[#2445CD] flex flex-col gap-[100px] pt-20 text-white px-[15px] lg:px-40">
      ...
      <div className="w-[100%]  rounded-[30px] flex flex-col items-end  md:flex md:flex-row-reverse md:items-start md:justify-between ">
        ...
        <div className="flex flex-row-reverse gap-24 ">
          <div className="text-end">
            ...
            <p className="text-[18px] cursor-pointer text-end font-semibold  mt-5">
              اكس
            </p>
            <p className="text-[18px] cursor-pointer text-end font-semibold  mt-5">
              انستجرام
          ...
          <div className="text-end">
            ...
            {/* <p className="text-[18px] cursor-pointer text-end font-semibold  mt-5">انستجرام</p>
            <p className="text-[18px] cursor-pointer text-end font-semibold  mt-5">تيك توك</p>
            <p className="text-[18px] cursor-pointer text-end font-semibold  mt-5">لينكد إن</p> */}
          </div>
        </div>
      </div>
      ...
      <div className=" flex flex-col items-center gap-2 md:flex justify-center md:flex-row-reverse md:justify-between mt-20 py-5 border-t border-white">
        ...
        <div className="flex  gap-4">
          <p className="text-[18px] text-end font-semibold cursor-pointer  ">
            الشروط
          </p>
          <p className="text-[18px] text-end font-semibold cursor-pointer ">
            الخصوصية
